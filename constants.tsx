...
export const COLORS = {
  PRIMARY: '#002855', // Safran Blue retained as primary brand
  ACCENT: '#3b82f6',
  SAFRAN_RED: '#E1000F',
  STATUS: {
    ON_TRACK: 'text-emerald-600 bg-emerald-50 border-emerald-100',
    AT_RISK: 'text-amber-600 bg-amber-50 border-amber-100',
